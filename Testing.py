...
while run == True:
    ...
    if kopfform == "rund":
        ...
        print("Okay eckig also")
        run = False
        eckig = True
    else:
        print("Als rund bezeichnet man die Form eines Kreises, im Wesentlichen ohne Ecken und Kanten!")
